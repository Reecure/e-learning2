...
const QuizProgressBar: FC<Props> = ({totalQuestion, currentQuestion}) => {
    ...
    return (
        <div className={"flex items-center gap-3 w-[300px]"}>
            <div className={`h-4 bg-neutral-600 rounded-full relative w-full`}>
                <div
                    className="h-full bg-dark-primary-main rounded-full absolute left-0 transition-all duration-200"
