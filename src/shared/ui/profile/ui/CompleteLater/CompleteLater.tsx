...
const CompleteLater: FC<Props> = ({user_id}) => {
    ...
    if (user_read_later.data?.length === 0) {
        return <div
            className={" flex flex-col justify-center items-center w-full min-w-[260px] max-w-[340px] sm:w-[340px] h-[310px] rounded-md border-dashed border-2 border-light-primary-main dark:border-dark-primary-main"}>
